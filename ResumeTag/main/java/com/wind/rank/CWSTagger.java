 ...
 *@version Time:Feb 18, 2014  5:01:46 PM
 *@Description 基于FuDanNLP中CRF模型实现的分词器
 */
...
public class CWSTagger extends AbstractTagger {
	 ...
	 * 
	 * @param segPath 模型的路径
	 * @param dicPath 自定义词典路径
	 * @throws Exception
	 */
	public CWSTagger(String segPath,String dicPath) throws Exception{
		this(segPath);
		Dictionary dictionary = new Dictionary(dicPath);
		initDict(dictionary);
	}
